      ...
      <div className="bg-slate-900 border-b border-slate-800 px-6 py-3 flex items-center justify-between min-h-[70px] backdrop-blur-md bg-opacity-95">
        ...
        >
          ...
          <div className="relative" ref={notifRef}>
            <div
              className="flex items-center justify-center w-8 h-8 rounded-full hover:bg-slate-800 cursor-pointer text-slate-400 hover:text-white transition-colors"
              onClick={() => setNotifOpen(!notifOpen)}
            >
              <Bell size={18} />
              {unreadCount > 0 && (
                <span className="absolute top-0 right-0 flex h-3 w-3 items-center justify-center rounded-full bg-red-500 text-[8px] text-white font-bold ring-2 ring-slate-900">
            ...
            {notifOpen && (
              <div className="absolute top-12 right-0 md:right-auto md:left-1/2 md:-translate-x-1/2 w-72 md:w-80 bg-slate-900 border border-slate-700/50 rounded-xl shadow-2xl z-50 overflow-hidden animate-in zoom-in-95 duration-200">
                      ...
                      {notifications.map((notif) => {
                        ...
                        return (
                          <div
                            ...
                            className={`p-4 border-b border-slate-800 transition-colors cursor-pointer ${
                              isUnread
                          ...
                          >
                            <div className="flex justify-between items-start mb-1 gap-2">
                              <h4
                                className={`text-sm ${isUnread ? "font-semibold text-white" : "font-medium text-slate-300"}`}
                              >
                                {notif.title}
                              </h4>
                              {isUnread && (
                            ...
                            <p
                              className={`text-xs ${isUnread ? "text-slate-300" : "text-slate-500"}`}
                            >
                              {notif.message}
                            </p>
