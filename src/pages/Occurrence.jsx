            ...
            <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
              ...
              <div>
                <div className="grid grid-cols-2 gap-4">
                  <label
                    className={`cursor-pointer p-4 border rounded-xl flex flex-col items-center justify-center gap-3 transition-all ${form.unusualOccurrence === "No" ? "bg-emerald-500/10 border-emerald-500/50 text-emerald-400" : "bg-slate-900/50 border-slate-700 text-slate-400 hover:bg-slate-800"}`}
                  >
                    <input
                      type="radio"
                  ...
                  <label
                    className={`cursor-pointer p-4 border rounded-xl flex flex-col items-center justify-center gap-3 transition-all ${form.unusualOccurrence === "Yes" ? "bg-red-500/10 border-red-500/50 text-red-400" : "bg-slate-900/50 border-slate-700 text-slate-400 hover:bg-slate-800"}`}
                  >
                    <input
                      type="radio"
                      name="unusualOccurrence"
